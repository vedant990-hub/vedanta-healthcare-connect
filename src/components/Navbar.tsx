        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <div className="bg-medical-light p-2 rounded-lg">
              <Heart className="h-8 w-8 text-medical-red fill-current" />
            </div>
            <div className="flex flex-col">
              <span className="text-xl font-bold text-medical-blue">Vedanta Healthcare</span>
              <span className="text-xs text-medical-gray">Mumbai, India</span>
            </div>
          </Link>
